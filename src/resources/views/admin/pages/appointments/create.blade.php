...
@section('body')
    <!-- Table Area Start -->
    <div class="container-fluid vh-100 bg-black p-5" id="appointment">
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <form @submit.prevent="saveAppointment" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select v-model="specializationId" @change="handleChange('specialization')"
                                    ...
                                    <option v-for="item in specializations" :value="item.id" :key="item.id">
                                        @{{ item.title }}
                                    </option>
                                </select>
                            </div>
                ...
                async saveAppointment() {
                    ...
                    if (isValidationPassed) {
                        ...
                        this.post(url, appointmentObject).then(data => {
                                if (data.status == "ok") {
                                    this.$toast('Appointment create successfully');
                                    notify();
