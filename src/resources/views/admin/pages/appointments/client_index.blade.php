...
@section('body')
    <!-- Table Area Start -->
    <div class="container-fluid bg-black p-5 vh-100">
                ...
                <table class="border-none w-100" id="table">
                    ...
                    <tbody class="text-light border-none">
                        ...
                        @foreach ($appointments as $i => $appointment)
                            <tr class="mb-3 align-items-center">
                                <td scope="row">
                                ...
                                {{-- <td scope="row"><input type="checkbox" id="appointmentIds_{{ $appointment->id }}"
                                        class="mt-3" name="selectedIds[]" value="{{ $appointment->id }}"
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu bg-black">
                                            ...
                                            {{-- @if (count($appointment->assessments) > 0)
                                                <li class="dropdown-item text-light"
                                                    style="cursor: pointer; border:1px solid #ffdd00"
                                                    id="viewNotes_{{ $appointment->id }}"
                                                    onclick="showAssessment({{ $appointment->id }})">
                                                    My Assessments
                                                </li>
                                            @endif --}}
                                            {{-- {{ dd($appointment->assessments) }} --}}
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content bg-dark">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-white" id="exampleModalLabel">Do You Confirm
                                                    to
...
@section('extra-script')
    ...
    <script src="{{ asset('admin/table.table.js') }}"></script>
    <script src="{{ asset('admin/table.export-users.js') }}"></script>
