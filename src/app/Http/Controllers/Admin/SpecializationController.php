...
class SpecializationController extends Controller
{
    ...
    private $moduleName = "Specialization";
    private $singularVariableName = 'specialization';
    private $pluralVariableName = 'specializations';
    ...
    {
        $this->moduleObject = new Specialization();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($this->moduleObject->create($specialization)) {
