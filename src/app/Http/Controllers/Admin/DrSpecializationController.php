...
class DrSpecializationController extends Controller
{
    private $moduleObject;
    private $moduleName = "DrSpecialization";
    private $singularVariableName = 'drspecialization';
    private $pluralVariableName = 'drspecializations';
    ...
    {
        $this->moduleObject = new DrSpecialization();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($this->moduleObject->create($drspecializations)) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($oldData->update($drspecializations)) {
