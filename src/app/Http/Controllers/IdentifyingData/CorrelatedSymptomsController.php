...
class CorrelatedSymptomsController extends Controller
{
    private $moduleObject;
    private $moduleName = "CoRealatedSymptoms";
    private $singularVariableName = 'co_realated_symptom';
    private $pluralVariableName = 'co_realated_symptoms';
    ...
    {
        $this->moduleObject = new CoRealatedSymptoms();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'symtoms_name.required' => 'The co-releted symptom name field is required'
        ]);
        if ($validator->fails()) {
        ...
        try {
            ...
            $co_realated_symptom = $this->moduleObject->GetData($request->all());
            // dd($parents_information);

            if ($this->moduleObject->create($co_realated_symptom)) {
