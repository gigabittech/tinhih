...
class UserSymtomsController extends Controller
{
    private $moduleObject;
    private $moduleObject1;
    private $moduleName = "UserSymptoms";
    private $singularVariableName = 'user_symptom';
    private $pluralVariableName = 'user_symptoms';
    ...
    public function __construct()
    {
        ...
        $this->moduleObject = new UserSymtoms();
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'symtoms_id.required' => 'Please select a Symptom'
        ]);
        ...
        try {
            ...
            $user_symptom = $this->moduleObject->GetData($request->all());
            // dd($parents_information);

            if ($this->moduleObject->create($user_symptom)) {
